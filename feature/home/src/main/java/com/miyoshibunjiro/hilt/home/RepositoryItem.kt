...
import com.miyoshibunjiro.hilt.core.EqualableContentsProvider
import com.miyoshibunjiro.hilt.home.databinding.ItemRepositoryBinding
...
) : BindableItem<ItemRepositoryBinding>(repository.id.toLong()),
